...
export function Header({ status }: { status: LineageStatus }) {
  return (
    <header className="sticky top-0 z-30 border-b border-line/8 bg-bg/70 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-3">
        <div className="flex items-center gap-3">
          <Mark />
          <div className="leading-none">
            <div className="flex items-center gap-2">
              <span className="font-serif text-[1.35rem] font-medium tracking-tightest text-text">
                Achilles
              </span>
...
function Mark() {
  return (
    <span className="grid h-9 w-9 place-items-center rounded-xl border border-line/12 bg-surface/70 shadow-card">
